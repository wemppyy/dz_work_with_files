...
void countNegativeNumbersUsingFilePointers(const std::string& inputFile, const std::string& outputFile) {
...
int main() {
    ...
    countNegativeNumbersUsingFilePointers(inputFile, outputFile);
    return 0;
}
