...
void processNumbersUsingFilePointers(const std::string& inputFile, const std::string& negativeFile, const std::string& positiveFile) {
...
int main() {
    ...
    processNumbersUsingFilePointers(inputFile, negativeFile, positiveFile);
